...
--
-- Host: localhost:3307
-- Generation Time: Jan 08, 2023 at 02:54 PM
...
(25, 102, '2023-01-02', 150000, 'Jl. Telekomunikasi Jl. Terusan Buah Batu, Sukapura'),
(26, 2, '2023-01-02', 150000, 'Jl. Lengkong Besar No.8, Cikawao, Kec. Lengkong, Kota Bandung, Jawa Barat 40261 \r\nNo Telp. (022) 30008000'),
(27, 107, '2023-01-03', 150000, 'Mutiara cibaduyut, Bandung, Jawa Barat'),
(28, 2, '2023-01-04', 150000, ''),
(29, 2, '2023-01-08', 150000, 'Cianjur');
...
(12, 'alex', 4, 'bagus'),
(13, 'vanna', 4, 'mantap pengirimannya');
...
(107, 'Khalid H', 'khalid', 'djkhalid'),
(108, 'Alex chindoppler', 'alex', 'alex1234'),
(109, 'Drake Welch', 'drake', 'drake1234');
...
ALTER TABLE `pembelian`
  ...
  ADD KEY `pembelian_ibfk_1` (`idUser`);
...
ALTER TABLE `pembelian_produk`
  ...
  ADD KEY `pembelian_produk_ibfk_1` (`id_pembelian`),
  ADD KEY `pembelian_produk_ibfk_2` (`kodeHoodie`);
...
--
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `pembelian_produk`
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `reviewhoodie`
--
ALTER TABLE `reviewhoodie`
  MODIFY `idReview` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `idUser` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `hoodie`
  ADD CONSTRAINT `hoodie_ibfk_1` FOREIGN KEY (`idAdmin`) REFERENCES `admin` (`idAdmin`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pembelian`
--
ALTER TABLE `pembelian`
  ADD CONSTRAINT `pembelian_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pembelian_produk`
  ...
  ADD CONSTRAINT `pembelian_produk_ibfk_2` FOREIGN KEY (`kodeHoodie`) REFERENCES `hoodie` (`kodeHoodie`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
