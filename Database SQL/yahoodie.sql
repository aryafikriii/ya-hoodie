...
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `users`
  MODIFY `idUser` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `pembelian`
  ADD CONSTRAINT `pembelian_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`);
...
ALTER TABLE `pembelian_produk`
  ...
  ADD CONSTRAINT `pembelian_produk_ibfk_2` FOREIGN KEY (`kodeHoodie`) REFERENCES `hoodie` (`kodeHoodie`);
COMMIT;
