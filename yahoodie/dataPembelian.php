...
<html lang="en">
    <head>
        ...
        <title>Tables - YA-HOODIE Admin</title>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="dashboardAd">YA-Hoodie</a>
            <!-- Sidebar Toggle-->
                                    ...
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="detailadmin.php?halaman=detail&id=<?php echo $pecah['id_pembelian'];?>">Detail</a>
                                                </td>
                                            </tr>
                                            <?php $nomor++;?>
                                            <?php } ?>
