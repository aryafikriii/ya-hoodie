...
<section class="keranjang">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-danger" href="hapuskeranjang.php?id=<?php echo $id_produk ?>">x</a>
                    </td>
                </tr>
                <?php $nomor++;?>
                <?php endforeach?>
        ...
        <a class="btn btn-primary" href="product.php">Lanjutkan belanja</a>
        <a class="btn btn-default" href="checkout.php" style="background-color:gray;color:white;">Checkout</a>
        <hr>
    </div>
</section>
